...
{"color_primaries", NULL, OFFSET(color_primaries), FF_OPT_TYPE_INT, {.dbl = AVCOL_PRI_UNSPECIFIED }, 1, AVCOL_PRI_NB-1, V|E|D, "color_primaries"},
{"bt709", NULL, 0, FF_OPT_TYPE_CONST, {.dbl = AVCOL_PRI_BT709 }, INT_MIN, INT_MAX, V|E, "color_primaries"},
{"bt470bg", NULL, 0, FF_OPT_TYPE_CONST, {.dbl = AVCOL_PRI_BT470BG }, INT_MIN, INT_MAX, V|E, "color_primaries"},
{"smpte170m", NULL, 0, FF_OPT_TYPE_CONST, {.dbl = AVCOL_PRI_SMPTE170M }, INT_MIN, INT_MAX, V|E, "color_primaries"},
{"color_transfer", NULL, OFFSET(color_transfer), FF_OPT_TYPE_INT, {.dbl = AVCOL_TRC_UNSPECIFIED }, 1, AVCOL_TRC_NB-1, V|E|D, "color_transfer"},
{"bt709", NULL, 0, FF_OPT_TYPE_CONST, {.dbl = AVCOL_TRC_BT709 }, INT_MIN, INT_MAX, V|E, "color_transfer"},
{"color_matrix", NULL, OFFSET(color_matrix), FF_OPT_TYPE_INT, {.dbl = AVCOL_MTX_UNSPECIFIED }, 1, AVCOL_MTX_NB-1, V|E|D, "color_matrix"},
{"bt709", NULL, 0, FF_OPT_TYPE_CONST, {.dbl = AVCOL_MTX_BT709 }, INT_MIN, INT_MAX, V|E, "color_matrix"},
{"smpte170m", NULL, 0, FF_OPT_TYPE_CONST, {.dbl = AVCOL_MTX_SMPTE170M }, INT_MIN, INT_MAX, V|E, "color_matrix"},
